...
urlpatterns.extend([
                         (r'accounts/login/$', communityViews.accounts_login),
                         (r'accounts/logout/$', communityViews.accounts_logout),
                         (r'accounts/forgot/$', communityViews.accounts_forgot),
                         (r'profile/(?P<user_id>\d+)/$', communityViews.profile),
                         (r'profile/edit/$', communityViews.profile_edit_mine),
                         (r'profile/edit/(?P<user_id>\d+)/$', communityViews.profile_edit),
