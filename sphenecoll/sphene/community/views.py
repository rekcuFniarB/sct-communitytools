...
def accounts_forgot(request, group = None):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'sphene/community/accounts/forgot_sent.html',
                                       { })
    else:
        form = ForgotUsernamePassword()
    return render(request, 'sphene/community/accounts/forgot.html',
                               { 'form': form,
                                 })
...
def register(request, group = None):
    ...
    return render(request, 'sphene/community/register.html',
                               { 'form': form })
...
def register_hash(request, email, emailHash, group = None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            login(request, user)
            return render(request, 'sphene/community/register_hash_success.html',
                                       { })
        return render(request, 'sphene/community/register_hash.html',
                                   { 'form': form })
...
def profile(request, group, user_id):
    ...
    return render(request, 'sphene/community/profile.html',
                               { 'profile_user': user,
...
def profile_edit(request, group, user_id):
    ...
    return render(request, 'sphene/community/profile_edit.html',
                               { 'profile_user': user,
                                 'form': form,
...
def admin_permission_rolegroup_list(request, group):
    ...
    return render(request, 'sphene/community/admin/permission/rolegroup_list.html',
...
def admin_permission_rolegroup_edit(request, group, rolegroup_id):
    ...
    return render(request, 'sphene/community/admin/permission/rolegroup_edit.html',
                               { 'rolegroup': rolegroup,
                                 })
...
def admin_permission_role_edit(request, group, role_id = None):
    ...
    return render(request, 'sphene/community/admin/permission/role_edit.html',
                               { 'form': form,
                                 })
...
def admin_permission_role_member_list(request, group, role_id):
    ...
    return render(request, 'sphene/community/admin/permission/role_member_list.html',
                               { 'members': members,
                                 'role': role,
                                 })
...
def admin_permission_role_member_add(request, group, role_id, addgroup = False):
    ...
    return render(request, 'sphene/community/admin/permission/role_member_add.html',
                               { 'form': form,
                                 'role': role,
                                 })
...
def reveal_emailaddress(request, group, user_id):
    ...
    return render(request, 'sphene/community/profile_reveal_emailaddress.html',
                               { 'form': form,
                                 })
