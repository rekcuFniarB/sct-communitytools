...
urlpatterns = [
        ...
        url(r'^feeds/latestposts/(?P<category_id>\d+)/$', LatestBlogPosts(),
                       ...
                       url(r'^archive/(?P<year>\d{4})/$', sphblog_views.blogindex, name='sphblog_archive_year'),
                       url(r'^archive/(?P<year>\d{4})/(?P<month>\d{1,2})/$', sphblog_views.blogindex, name='sphblog_archive_month'),
                       # Paged archives
                       url(r'^archive/(?P<year>\d{4})/page/(?P<page>\d+)/$', sphblog_views.blogindex, name='sphblog_archive_year_paged'),
                       url(r'^archive/(?P<year>\d{4})/(?P<month>\d{1,2})/page/(?P<page>\d+)/$', sphblog_views.blogindex, name='sphblog_archive_month_paged'),

                       url(r'^page/(?P<page>\d+)/$', sphblog_views.blogindex, name='sphblog_paged_index'),
