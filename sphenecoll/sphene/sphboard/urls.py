...
urlpatterns = [
                       ...
                       url(r'^feeds/all/$',
                        ...
                        url(r'^move_post_2/(?P<post_id>\d+)/(?P<category_id>\d+)/$', boardViews.move_post_2, defaultdict, name='move_post_2'),
                        url(r'^move_post_3_cat/(?P<post_id>\d+)/(?P<category_id>\d+)/$', boardViews.move_post_3, defaultdict, name='move_post_3'),
                        url(r'^move_post_3_thr/(?P<post_id>\d+)/(?P<category_id>\d+)/(?P<thread_id>\d+)/$', boardViews.move_post_3, defaultdict, name='move_post_3'),
