...
urlpatterns.extend([
                        ...
                        (r'^post/(?P<category_id>\d+)/(?P<post_id>\d+)/$', boardViews.post),
                        ...
                        (r'^annotate/(?P<post_id>\d+)/$', boardViews.annotate),
                        (r'^hide/(?P<post_id>\d+)/$', boardViews.hide),
                        ...
                        (r'^vote/(?P<thread_id>\d+)/$', boardViews.vote),
                        ...
                        (r'^catchup/(?P<category_id>\d+)/$', boardViews.catchup),
