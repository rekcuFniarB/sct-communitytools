...
urlpatterns = [
                       ...
                       url(r'^feeds/all/$',
                        ...
                        url(r'^thread/(?P<thread_id>\d+)/(?P<slug>.+)/$', boardViews.showThreadClass.as_view(), name = 'sphboard_show_thread'),
                        url(r'^thread/(?P<thread_id>\d+)/$', boardViews.showThreadClass.as_view(), name = 'sphboard_show_thread_without_slug'),
                        ...
                        url(r'^annotate/(?P<post_id>\d+)/$', boardViews.annotate, name='sphboard_annotate'),
                        url(r'^hide/(?P<post_id>\d+)/$', boardViews.hide, name='sphboard_hide'),
                        url(r'^move_post_1/(?P<post_id>\d+)/$', boardViews.move_post_1, name='sphboard_move_post_1'),
